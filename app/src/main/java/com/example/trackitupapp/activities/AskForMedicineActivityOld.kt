...
class AskForMedicineActivityOld : AppCompatActivity() {
        ...
        calls.callAddOrder(
            ...
            object : OrderCallback {
                override fun onSuccess(medicine: OrderResponse) {
                    finish()
                    Toast.makeText(this@AskForMedicineActivityOld, "Užsakymas sukurtas", Toast.LENGTH_SHORT).show()
                }

                override fun onFailure(message: String) {
                    Toast.makeText(this@AskForMedicineActivityOld, "Nepavayko sukurti užsakymo", Toast.LENGTH_SHORT).show()
                    finish()
                }
